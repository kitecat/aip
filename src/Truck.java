...
public class Truck extends Auto {
    ...
    public Truck(String firma, int speed, String gosNomerInput, String name, int n, Boolean f) {
        super(firma, speed, gosNomerInput);
        model = name;
        power = n;
        trailer = f;
    }
    ...
    public void setAllInfo() {
        ...
        String gosNomerInput = in.next(); //метод next() позволяет вводить строки, но без пробелов
        setGosNomer(gosNomerInput);
